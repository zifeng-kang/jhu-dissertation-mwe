...
% Removes 'Chapter #' chapter title while keeping
% it listed in the TOC
\newcommand\chap[1]{%
  \chapter*{#1}%
  \addcontentsline{toc}{chapter}{#1}}

% Removes 'Section #' chapter title while keeping
% it listed in the TOC
\newcommand\sect[1]{%
  \section*{#1}%
  \addcontentsline{toc}{section}{#1}}

% Removes 'Subsection #' chapter title while keeping
% it listed in the TOC
\newcommand\subsect[1]{%
  \subsection*{#1}%
